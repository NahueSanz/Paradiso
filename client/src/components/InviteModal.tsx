    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6">
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-bold text-gray-800">Invitar empleado</h2>
          <button
            onClick={onClose}
        ...
        {!inviteUrl ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700 mb-2">Link de invitación</p>
              <div className="flex gap-2">
                <input
                  type="text"
                  readOnly
                  value={inviteUrl}
                  className="flex-1 border border-gray-200 bg-gray-50 rounded-lg px-3 py-2
                             text-xs text-gray-600 focus:outline-none select-all"
                />
                <button
                  onClick={handleCopy}
                  className="px-3 py-2 text-xs rounded-lg border border-gray-200 text-gray-600
